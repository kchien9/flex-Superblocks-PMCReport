...
2. **Register in Module Registry** — Status: `Coming Soon`, roles defined, one-sentence description.
...
7. **Activate** — Flip Module Registry status `Coming Soon → Active`. Confirm permissions.
...
- [ ] Module registered in Module Registry with correct roles
...
- [ ] Permissions matrix updated for this module
